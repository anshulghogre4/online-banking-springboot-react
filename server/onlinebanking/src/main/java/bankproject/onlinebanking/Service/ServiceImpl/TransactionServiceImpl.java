...
public class TransactionServiceImpl implements TransactionService{
    ...
    public List<Transactions> getDetailsByAccount(BankAccount bankAccount) {
        ...
        if(transactionRepository.getDetailsByAccountNo(bankAccount.getAccountno())!=null)
        {
            return null;
        }
       return transactionRepository.getDetailsByAccountNo(bankAccount.getAccountno()); 
    }
