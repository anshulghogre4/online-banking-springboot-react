...
const AccTransaction = () => {
    ...
    return (
        <>
            ...
            <div><h1 className="mt-0 mb-2 text-5xl font-medium leading-tight text-primary">Transactions by account no I'm admin / user</h1>
               <form  onSubmit = {getAllAccTransactions}>
                    <input type="text" name="accno" id="accno" onChange={handleChange} /><br/>
                    <button className="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                        type="submit" id="submit" >Transactions</button>
                </form>
                <button
                    ...
                    onClick={() => navigateTo("/admin/transactions")}>Back </button>
